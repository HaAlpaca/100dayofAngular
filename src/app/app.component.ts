...
export class AppComponent {
  ...
  // }
  ngOnInit(): void {
    // console.log('OnInit', this.toggleComp, this.toggleButton, this.nameInput);
    // setTimeout(() => {
  ...
  //   // console.log(this.toggleComp, this.toggleButton, this.nameInput);
  // }
